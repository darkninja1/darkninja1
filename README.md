...
- [DapChat Official (Chat)](https://dapchat.repl.co) | 2022-23 10th grade hobby project | writing and changing around 500000+ lines of code (learned from this highly inefficient project) | includes 10 other implemented games and programs (todolist, memory, reaction games, casino games, live radio, etc...)
